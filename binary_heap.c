...
void heapifyTtB(HEAP *heap, int index){
    ...
    if((left < index && heap->heap_node[index].value > left_child->value) && (right < index && heap->heap_node[index].value > right_child->value)){
        // printf("HAHAHAHHA\n");
    ...
    if(left < index && heap->heap_node[index].value > left_child->value){
        // printf("HAHAHAHHA2\n");
        swap_heap_nodes(&heap->heap_node[index], &heap->heap_node[left]);
        heapifyTtB(heap, left_child->value);
    }
    if(right < index && heap->heap_node[index].value > right_child->value){
        // printf("HAHAHAHHA3\n");
